    ...
    <div className="animate-fade-in pb-28">
      ...
      <div className="fixed bottom-0 left-0 right-0 z-50 border-t bg-background/90 backdrop-blur-xl safe-bottom">
        <div className="mx-auto flex max-w-md items-center gap-3 px-4 py-3">
          <button className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-secondary tap-highlight">
          ...
          {book.listen_time_min && book.listen_time_min > 0 && (
            <Button variant="secondary" className="h-11 flex-1 gap-2 rounded-xl text-sm font-semibold">
